        ...
        <div className="px-6 py-4 border-b border-slate-200 bg-slate-50/80 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <span className="text-xs font-bold text-purple-700">{progress}% Completed</span>
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 overflow-hidden">
          ...
          <div className="lg:col-span-2 flex flex-col overflow-y-auto p-4 sm:p-6 space-y-6 border-b lg:border-b-0 lg:border-r border-slate-200">
            ...
            <div className="relative aspect-video w-full rounded-2xl bg-slate-950 overflow-hidden shadow-lg flex items-center justify-center group border border-slate-800">
              ...
              <div className="relative z-10 flex flex-col items-center text-center p-6 space-y-3">
                <div className="w-16 h-16 rounded-full bg-purple-600/90 text-white flex items-center justify-center shadow-lg shadow-purple-500/40 group-hover:scale-110 transition-transform">
                  <PlayCircle className="w-8 h-8" />
                </div>
                <div>
                  <p className="text-xs font-mono text-purple-300 tracking-wider uppercase">Active Module Lesson</p>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 p-4 rounded-xl bg-purple-50 border border-purple-100">
              <div>
                <p className="text-xs text-purple-700 font-semibold uppercase tracking-wider">Lesson Status</p>
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 rounded-xl bg-slate-900 text-slate-300 font-mono text-xs overflow-x-auto border border-slate-800 space-y-2">
                ...
                <p className="text-purple-300 font-semibold">import &#123; createEngine &#125; from &apos;@rwstech/runtime&apos;;</p>
              ...
              <div className="flex items-center justify-between text-xs text-slate-500 pt-1">
                ...
                <button
                  ...
                  className="text-purple-700 hover:text-purple-900 font-semibold flex items-center gap-1 hover:underline"
                >
          ...
          <div className="flex flex-col h-full bg-slate-50/60 overflow-y-auto p-4 space-y-4">
                  ...
                  >
                    <button
                      ...
                      className={`w-full px-3.5 py-3 text-left flex items-center justify-between transition-colors ${
                        isSelected ? 'bg-purple-50/80 border-b border-purple-100' : 'hover:bg-slate-50'
                      }`}
                    >
            ...
            <div className="mt-auto pt-4 border-t border-slate-200">
              <div className="p-3.5 rounded-xl bg-gradient-to-tr from-purple-900 to-indigo-900 text-white space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] uppercase font-bold tracking-wider text-purple-200">Official Certificate</span>
