...
export function Footer() {
  return (
    <footer id="main-footer" className="bg-slate-950 text-slate-300 relative overflow-hidden border-t border-purple-950">
      ...
      <div className="absolute bottom-0 -left-40 w-96 h-96 bg-indigo-600/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-900/50 border border-purple-700/50 text-[11px] font-semibold text-purple-200">
                <ShieldCheck className="w-3.5 h-3.5 text-purple-400" />
                ISO 9001:2026 Certified
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-900/50 border border-indigo-700/50 text-[11px] font-semibold text-indigo-200">
            ...
            <div className="pt-3">
              ...
              <div className="flex items-center gap-2.5">
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-slate-900 hover:bg-gradient-to-tr hover:from-purple-600 hover:to-pink-600 border border-slate-800 text-slate-400 hover:text-white flex items-center justify-center transition-all"
                >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-4 border-l-2 border-purple-500 pl-2.5">
              Quick Links
            </h4>
            ...
            <ul className="space-y-3.5 text-xs text-slate-400">
              <li className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <a href="mailto:support@rwstech.com" className="hover:text-purple-300 transition-colors">
                    support@rwstech.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <a href="tel:+918004567890" className="hover:text-purple-300 transition-colors">
                    +91 (800) 456-7890
                  </a>
                </div>
              </li>
