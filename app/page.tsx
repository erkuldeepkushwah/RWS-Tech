...
export default function HomePage() {
  ...
  return (
    <div id="home-view" className="space-y-20 pb-20">
      ...
      <section
        id="hero-section"
        className="relative pt-8 pb-16 md:py-24 bg-gradient-to-b from-purple-50/70 via-white to-slate-50 border-b border-purple-100/80 overflow-hidden"
      >
        {/* Subtle background ambient circles */}
        <div className="absolute top-10 left-1/4 w-72 h-72 bg-purple-200/40 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute top-20 right-10 w-96 h-96 bg-indigo-200/30 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[1.1]">
                ...
                <span className="bg-gradient-to-r from-purple-800 via-purple-600 to-indigo-600 bg-clip-text text-transparent">
                  With Technology
                </span>
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <button
                  ...
                  className="px-7 py-3.5 rounded-xl font-bold text-white bg-gradient-to-r from-purple-700 via-purple-600 to-indigo-600 hover:from-purple-800 hover:to-indigo-700 shadow-lg shadow-purple-600/25 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center gap-2"
                >
                ...
                <button
                  ...
                  className="px-7 py-3.5 rounded-xl font-bold text-slate-800 bg-white hover:bg-slate-50 border border-slate-300/80 shadow-xs hover:border-purple-300 transition-all flex items-center gap-2"
                >
              ...
              {/* Hero Micro-Features */}
              <div className="pt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs text-slate-600 border-t border-slate-200/80">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-md lg:max-w-none">
                ...
                >
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-tr from-purple-700 to-indigo-600 text-white flex items-center justify-center font-bold shadow-md shadow-purple-500/30">
                ...
                <div className="absolute top-1/2 -right-4 translate-y-6 bg-purple-700 text-white px-3 py-1.5 rounded-full shadow-lg text-[11px] font-bold flex items-center gap-1.5 hidden md:flex border border-purple-400/30">
      ...
      <section id="stats-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 sm:-mt-10 relative z-20">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {stats.map((stat, idx) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-purple-50 group-hover:bg-purple-100 text-purple-700 flex items-center justify-center shrink-0 transition-colors">
                {stat.icon}
              </div>
              <div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200/90 p-6 sm:p-10 lg:p-12 shadow-sm space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-2">
            {pillars.map((pillar, idx) => (
              <div
                key={idx}
                className="p-6 rounded-2xl bg-slate-50/80 hover:bg-purple-50/50 border border-slate-200/70 hover:border-purple-200 transition-all space-y-3 group"
              >
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-white flex flex-col justify-between space-y-4">
              ...
              <button
                onClick={() => navigateTo('courses')}
                className="w-full py-2.5 px-4 rounded-xl text-xs font-bold text-purple-900 bg-white hover:bg-purple-50 transition-colors flex items-center justify-center gap-2 shadow-md"
              >
                Browse All Courses
      ...
      <section id="courses-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-purple-700">
          ...
          <button
            onClick={() => navigateTo('courses')}
            className="self-start md:self-auto px-5 py-2.5 rounded-xl text-xs font-bold text-purple-700 bg-purple-50 hover:bg-purple-100 border border-purple-200 transition-colors flex items-center gap-1.5"
          >
            View All 24 Courses
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-purple-900 via-indigo-950 to-slate-950 text-white rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-xl">
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col items-center sm:items-end justify-center">
              <button
                onClick={() => navigateTo('courses')}
                className="w-full sm:w-auto px-8 py-4 rounded-xl text-sm font-bold text-slate-900 bg-white hover:bg-purple-50 shadow-lg shadow-black/30 transition-all hover:scale-105 flex items-center justify-center gap-2"
              >
